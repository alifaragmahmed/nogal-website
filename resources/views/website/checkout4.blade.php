   ...
   <section class="main-header" style="background-image:url(assets/images/gallery-2.jpg)">
        ...
        <section class="checkout">
            <div class="container">
                ...
                <header class="hidden">
                    <h3 class="h3 title">  {{__('Checkout - Step 4')}}</h3>
                </header>
                ...
                <div class="clearfix">
                    <div class="row">
                        <div class="col-xs-6">
                            <span class="h2 title">  {{__('Your order is completed!')}}</span>
                        </div>
                        <div class="col-xs-6 text-right">
                            <a onclick="window.print()" class="btn btn-main"><span class="icon icon-printer"></span>  {{__('Print')}} </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="white-block">
                                    ...
                                    <div class="h4"> {{__('payment status')}}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              @if( request()->success == 'false'){
                                               ...
                                               <span class="label label-danger" >  {{__('failed')}}  
                                               </span>
                                               }
                                              
                                              @else{
                                              
                                               <span class="label label-success" >  {{ __('success')}}  
                                               </span>
                                    ...
                                    <div class="h4">  {{__('Payment details')}}</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>  {{__('Transaction time')}}</strong> <br />
                                                <span>{{ date("Y-m-d H:i:s", strtotime(request()->created_at)) }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>  {{__('Cart details')}}</strong><br />
                                                <span>**** **** **** 5446</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>  {{__('Items in cart')}}</strong><br />
                ...
                <div class="cart-wrapper">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="cart-block cart-block-item clearfix">
                            ...
                            <div class="price">
                                <span class="final h3">{{ $detail->price }} EGP</span> 
                            </div>
                            <!--delete-this-item-->
