...
<body>
  ...
  padding: 20px" >
      ...
      <p class="greeting"> Be the first to hear of our greatest offers! </p>

      <!-- Order info -->
      <div class="order">

        <p> Offer No : {{ count($products) }} </p>
        <p> Date : {{ date('Y-m-d') }} </p>
        <p> Address : {{ optional(App\Setting::find(8))->value }} </p>
